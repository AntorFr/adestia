 ...
 */
import type { McpServer } from '@antorfr/adestia-drivers'
...
const MANIFEST = 'adestia-plugin.json'
const SKIN_MANIFEST = 'adestia-skin.json'
 ...
 * the user's and the agent's, and Adestia neither parses nor translates it. Same
