 ...
 *
 * Golem writes `:::callout{type=warning}`. A body of pages written by the
 ...
 *
 * So Golem LEARNS TO READ them. Not a migration — the other shell still reads
...
/**
 * The predecessor's callout types, in Golem's closed vocabulary.
 *
 ...
 * predecessor draws a card with the site's favicon, which Golem has no
 ...
 * knowing — saving such a page in the editor rewrites its blocks into Golem's
