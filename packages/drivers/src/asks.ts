 ...
 * Adestia judges nothing — the ENGINE decides a call needs a person, and this
 * holds that question until somebody answers it. Adestia is the surface, never
 ...
 * the workspace — not by Adestia. That is the whole point: the durable
 * allowlist is a file a person can open, read and edit, maintained by the CLI
 * that enforces it. Adestia keeps no list, and never did after 2026-08-26.
 */
