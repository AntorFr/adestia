...
two parsers means drift."* Adestia's renderer is unified/remark (directives are
...
1. Adestia abandons remark for rendering (no reason in sight — directives).
2. Milkdown maintenance collapses (last publish 2026-08-12 at verdict time).

## Adopted mitigations

- **Editor behind a Adestia interface, never bare** — the Tiptap spike is the
